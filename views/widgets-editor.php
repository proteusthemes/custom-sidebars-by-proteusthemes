...
<form class="wpmui-form">
	...
	<div class="wpmui-grid-8 no-pad-top">
		<div class="col-3">
			<label for="csb-name"><?php _e( 'Name', PT_CS_TD ); ?></label>
			<input type="text" name="name" id="csb-name" maxlength="40" placeholder="<?php _e( 'Sidebar name here...', PT_CS_TD ); ?>" />
			<div class="hint"><?php _e( 'The name must be unique.', PT_CS_TD ); ?></div>
		</div>
		<div class="col-5">
			<label for="csb-description"><?php _e( 'Description', PT_CS_TD ); ?></label>
			<input type="text" name="description" id="csb-description" maxlength="200" placeholder="<?php _e( 'Sidebar description here...', PT_CS_TD ); ?>" />
		</div>
	</div>
	<hr class="csb-more-content" />
	<div class="wpmui-grid-8 csb-more-content">
		<div class="col-8 hint">
			<strong><?php _e( 'Caution:', PT_CS_TD ); ?></strong>
			<?php _e(
				...
				'the design of your site. Leave these fields blank to use the theme sidebars design.', PT_CS_TD
			); ?>
		</div>
	</div>
	<div class="wpmui-grid-8 csb-more-content">
		<div class="col-4">
			<label for="csb-before-title"><?php _e( 'Before Title', PT_CS_TD ); ?></label>
			<textarea rows="4" name="before_title" id="csb-before-title"></textarea>
		</div>
		<div class="col-4">
			<label for="csb-after-title"><?php _e( 'After Title', PT_CS_TD ); ?></label>
			<textarea rows="4" name="after_title" id="csb-after-title"></textarea>
		</div>
	</div>
	<div class="wpmui-grid-8 csb-more-content">
		<div class="col-4">
			<label for="csb-before-widget"><?php _e( 'Before Widget', PT_CS_TD ); ?></label>
			<textarea rows="4" name="before_widget" id="csb-before-widget"></textarea>
		</div>
		<div class="col-4">
			<label for="csb-after-widget"><?php _e( 'After Widget', PT_CS_TD ); ?></label>
	...
	<div class="buttons">
		<label for="csb-more" class="wpmui-left">
			...
			<?php _e( 'Advanced - Edit custom wrapper code', PT_CS_TD ); ?>
		</label>

		<button type="button" class="button-link btn-cancel"><?php _e( 'Cancel', PT_CS_TD ); ?></button>
		<button type="button" class="button-primary btn-save"><?php _e( 'Create Sidebar', PT_CS_TD ); ?></button>
	</div>
</form>
